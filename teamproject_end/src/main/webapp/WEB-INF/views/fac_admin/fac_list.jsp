    ...
    <div id="content-wrapper" class="d-flex flex-column">
     ...
     <div class="container-fluid" id="container-wrapper">
            ...
            <div class="col-lg-12">
              <div class="card mb-4" id="mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h3 class="m-0 font-weight-bold text-primary">시설 목록 현황</h3>
          ...
          <div class="table-responsive p-3">
            ...
            <!-- 데이터 들어오는 부분 -->
              <tbody>
	              <c:forEach var="facVo" items="${map.list}">
	                <tr>
	                  <td>${facVo.finfo_no}</td>
	                  <td>${facVo.fm_id}</td>
	                  <td>${facVo.finfo_name}</td>
	                  <td>${facVo.finfo_price}원</td>
	                  <td>${facVo.finfo_people}</td>
	                  <td>5</td>
	                  <td><a href="booking?finfo_no=${facVo.finfo_no}">VIEW</a></td>
	                </tr>
	              </c:forEach>
              </tbody>
            </table>
