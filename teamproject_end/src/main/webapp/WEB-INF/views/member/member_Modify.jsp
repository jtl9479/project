            ...
            <div class="col-lg-12">
              <div class="card mb-4" id="mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h3 class="m-0 font-weight-bold text-primary">마이 페이지 수정</h3>
                </div>
                ...
                <div id="mem_inform_input1">
                  <form action="member_Modify" name="mem_check" method="post">
                    <div class="form-group" id="mem_input">
                      ...
                      <label for="exampleInputPassword1">성별 </label>
						...
						<div>
	                        <span class="custom-control custom-radio">
	                          <input type="radio" id="male" name="gender" class="custom-control-input" value="male" ${memberVo.m_gender eq 'male'? 'checked':'' }>
	                          <label class="custom-control-label" for="male" id="male1" >남자</label>
	                        </span>
	                        <span class="custom-control custom-radio">
	                          <input type="radio" id="female" name="gender" class="custom-control-input" value="female" ${memberVo.m_gender eq 'female'? 'checked':'' }>
                      ...
                      <input type="email" placeholder="이메일" id="email" name="email" value="${memberVo.m_email}" readonly="readonly">
