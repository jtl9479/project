						...
						<c:forEach items="${map.eventList }" var = "eventVo">
							<div class="single-recent-blog-post item">
								...
								<div class="details">
									...
									<c:if test="${eventVo.eb_status == 0 }">
										<span class = "event_status">이벤트 예정</span>
									</c:if>
									<c:if test="${eventVo.eb_status == 1 }">
										<span class = "event_status">이벤트 진행중</span>
									</c:if>
									<c:if test="${eventVo.eb_status == 2 }">
		            ...
		            <div class="row">
		                <div class="active-testimonial">
		                    <div class="single-testimonial item d-flex flex-row">
	                           <img class="img-fluid-1" src="img/ad/cityTour.jpg" alt="">
		                    </div>
		                    <div class="single-testimonial item d-flex flex-row">
	                           <img class="img-fluid-1" src="img/ad/youngjuInterior.jpg" alt="">
		                    </div>
		                    <div class="single-testimonial item d-flex flex-row">
	                           <img class="img-fluid-1" src="img/ad/cityTour.jpg" alt="">
		                    </div>
