...
<body>
	<div id="div">
		<div id="header_div">
			<div id="header_img">
				<h1 style="color: white; font-size: 50px; margin-left: 100px; padding-top: 10px;"><a href="eventBoardList">노리</a></h1>
			</div>
		</div>
		<div id="body_div">
			<!--  게시판 뷰 버튼 부분   -->
					...
					<div id="body_view_header1">
						<div>
							<div id="body_view_title">
								<span>이벤트게시판</span>
								<h3>${map.eventBoardVo.eb_title }
									<c:if test="${map.eventBoardVo.eb_status == 0 }">
										<span class = "event_status">이벤트 예정</span>
									</c:if>
									<c:if test="${map.eventBoardVo.eb_status == 1 }">
										<span class = "event_status">이벤트 진행중</span>
									</c:if>
									<c:if test="${map.eventBoardVo.eb_status == 2 }">
							...
							<div id="body_view_inform">
								<div id="body_view_inform_div1">
									<div id="body_view_inform_nickname">
										<span>${map.eventBoardVo.a_id}</span>
									</div>
