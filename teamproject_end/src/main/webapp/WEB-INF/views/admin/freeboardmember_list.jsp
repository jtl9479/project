      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
            ...
            <div class="col-lg-12">
              <div class="card mb-4" id="mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h3 class="m-0 font-weight-bold text-primary">회원 자유게시판 리스트</h6>
                </div>
          ...
          <div class="table-responsive p-3">
            ...
            <!-- 데이터 들어오는 부분 -->
              <tbody>
            <c:forEach items="${list }" var="FreeBoardMemberVo">
                <tr>
                  <td>${FreeBoardMemberVo.fbm_num }</td>
                  <td>${FreeBoardMemberVo.fbm_title }</td>
                  <td>${FreeBoardMemberVo.m_nickname }</td>
                  <td>${FreeBoardMemberVo.fbm_date }</td>
                  <td>${FreeBoardMemberVo.fbm_hit }</td>
                  <td><a href="/freeBoardMemberView?fbm_num=${FreeBoardMemberVo.fbm_num }">VIEW</a></td>
                </tr>
            </c:forEach>
              </tbody>
            </table>
