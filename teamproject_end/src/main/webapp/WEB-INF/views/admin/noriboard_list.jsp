      ...
      <div id="content">
        ...
        <DIV>
          ...
          <div class="table-responsive p-3">
            ...
            <!-- 데이터 들어오는 부분 -->
              <tbody>
              <c:forEach items="${list }" var="NoriBoardVo">
                <tr>
                  <td>${NoriBoardVo.nb_num }</td>
                  <td>${NoriBoardVo.nb_title }</td>
                  <td>${NoriBoardVo.nb_category }</td>
                  <td>${NoriBoardVo.m_nickname }</td>
                  <td>${NoriBoardVo.nb_date }</td>
                  <td>${NoriBoardVo.nb_hit }</td>
                  <td><a href="/noriBoardView?nb_num=${NoriBoardVo.nb_num  }">VIEW</a></td>
                </tr>
              </c:forEach>
              </tbody>
            </table>
